...
module ApplicationHelper
  ...
  def tabs(tabs = nil)
    tabs ||= controller_path =~ /admin/ ? IntfocusCore::Tabs.admin : IntfocusCore::Tabs.main
    if tabs
      ...
      raise IntfocusCore::MissingSettings, "Tab settings are missing, please run <b>rake rfocus:setup</b> command."
    end
  end
