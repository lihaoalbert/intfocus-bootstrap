...
class Product < ActiveRecord::Base
  ...
  scope :state, lambda { |filters|
    where('product_type IN (?)' + (filters.delete('other') ? ' OR product_type IS NULL' : ''), filters)
  }
  ...
  has_fields
  exportable
  sortable :by => [ "name ASC", "product_type ASC", "startup_date DESC", "created_at DESC", "updated_at DESC" ], :default => "created_at DESC"
