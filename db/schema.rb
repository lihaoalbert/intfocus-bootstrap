...
ActiveRecord::Schema.define(:version => 20120419185428) do
  ...
  create_table "macroeconomics", :force => true do |t|
    t.integer  "user_id"
  ...
  add_index "products", ["user_id", "name", "deleted_at"], :name => "index_products_on_user_id_and_name_and_deleted_at", :unique => true
  ...
  create_table "treecodes", :force => true do |t|
  ...
  add_index "treecodes", ["node_class", "node"], :name => "index_treecodes_on_node_class_and_node", :unique => true
