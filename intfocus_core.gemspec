...
Gem::Specification.new do |gem|
  gem.name = 'intfocus_core'
  gem.authors = ['Eric Yue', 'Albert Li']
  gem.summary = 'Intfocus Project'
  gem.description = 'Competitive Intelligence management platform'
  gem.homepage = 'http://intfocus.com'
  gem.email = ['eric_yue@intfocus.com', 'albert_li@intfocus.com']
  gem.files = `git ls-files`.split("\n")
  gem.version = IntfocusCore::VERSION::STRING
