...
class ActionController::Base
  rescue_from IntfocusCore::MissingSettings,  :with => :render_intfocus_core_exception
  rescue_from IntfocusCore::ObsoleteSettings, :with => :render_intfocus_core_exception

  private

  def render_intfocus_core_exception(exception)
