    ...
    module ClassMethods
      ...
      def uses_user_permissions
        unless included_modules.include?(InstanceMethods)
          ...
          include IntfocusCore::Permissions::InstanceMethods
          extend  IntfocusCore::Permissions::SingletonMethods
        end
      end
...
ActiveRecord::Base.send(:include, IntfocusCore::Permissions)
